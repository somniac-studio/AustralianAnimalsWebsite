<?php
    $animals = [
        ["commonname"=>"Cane Toad" , "taxonomy"=>"Amphibian" , "class"=>"aves" , "order"=>"Psittaciformes" , "genus"=>"Cacatua" , "species"=>"C.galerita"],
        ["commonname"=>"Green Tree Frog" , "taxonomy"=>"Amphibian" , "class"=>"aves" , "order"=>"Psittaciformes" , "genus"=>"Birb" , "species"=>"C.galerita"],
        ["commonname"=>"Waterfall Frog" , "taxonomy"=>"Amphibian" , "class"=>"aves" , "order"=>"Psittaciformes" , "genus"=>"Filler" , "species"=>"C.galerita"]
    ];
?>
...
<html>
        ...
        <h2>Amphibians Page, aka the Frog Zone</h2>
